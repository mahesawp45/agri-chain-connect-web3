...
const TransactionDetail = () => {
  ...
  const handleStartWhatsAppChat = () => {
    ...
    const message = language === "id"
      ...
      : `Hello ${transaction.buyerName}, I'm from ${transaction.sellerName}. Let's discuss more details about the ${transaction.commodityName} you ordered. Thank you.`;
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          {transaction?.status === "persiapan_pengiriman" && (
            <Card className="earth-card-clay overflow-hidden">
              <CardHeader className="earth-header-clay pb-3">
                <CardTitle className="text-white">
                  {language === "id" ? "Persiapan Pengiriman" : "Preparing for Shipment"}
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4 mt-2">
                <div className="p-4 bg-earth-clay/20 rounded-lg">
                  <div className="flex items-center space-x-2 mb-3">
                    ...
                    <h3 className="font-medium text-earth-dark-green">
                      {language === "id" ? "Siapkan Komoditas" : "Prepare Commodities"}
                    </h3>
                  </div>
                  
                  <p className="text-earth-medium-green mb-4">
                    {language === "id" 
                      ? "Siapkan komoditas Anda untuk pengiriman. Pastikan semua item sudah siap dan dikemas dengan aman."
                      : "Prepare your commodities for shipping. Ensure all items are ready and safely packed."}
                  </p>
