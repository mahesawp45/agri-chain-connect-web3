...
export function MainLayout({ children }: MainLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-earth-pale-green flex">
      ...
      <div className={cn("flex-1 flex flex-col relative", sidebarOpen ? "md:ml-64" : "md:ml-20")}>
        ...
        <footer className="py-4 px-6 text-center text-sm text-earth-dark-green border-t bg-earth-light-green/30 w-full">
